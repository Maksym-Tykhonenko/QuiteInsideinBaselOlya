...
export default function RootNavigator() {
  ...
  const INITIAL_URL = `https://clear-wave-pro.site/`;
  const URL_IDENTIFAIRE = `Eq9m6aeh`;
  ...
  OneSignal.initialize('d9668e3b-7ce2-433c-a3e1-6a4fb4b7a551');
  ...
  useEffect(() => {
    ...
    const targetData = new Date('2026-01-30T08:08:00'); //дата з якої поч працювати webView
